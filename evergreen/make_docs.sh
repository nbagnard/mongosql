...
MKFILE="$DIR/docs/mongodb-schema-manager/overview.md"

# Define the output PDF file name
OUTPUT_PDF="overview.pdf"

# Use pandoc to convert the markdown file to a PDF
pandoc -f gfm -V geometry:a4paper -V geometry:margin=2cm --toc -s -o "$DIR/docs/mongodb-schema-manager/$OUTPUT_PDF" $MKFILE
